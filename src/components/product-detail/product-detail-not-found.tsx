...
import { productDetailBreadcrumb, productDetailLabels } from "./content"
    ...
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <BrandEmpty className="rounded-[24px] border border-border bg-card shadow-soft">
        <BrandEmptyHeader>
          ...
          <BrandEmptyTitle>{productDetailLabels.notFoundTitle}</BrandEmptyTitle>
          <BrandEmptyDescription>
            {productDetailLabels.notFoundDescription}
          </BrandEmptyDescription>
        </BrandEmptyHeader>
        <BrandEmptyContent className="max-w-none">
          <BrandButton
            ...
            variant="destructive"
          >
            {productDetailLabels.notFoundAction}
          </BrandButton>
        </BrandEmptyContent>
      </BrandEmpty>
    </section>
